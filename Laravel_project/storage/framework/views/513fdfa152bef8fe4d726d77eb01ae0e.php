...
<div class="top-section fullscreen-container logo-nav-res default text-center mt-1" >
    <a href="<?php echo e(route('index')); ?>">
        <img height="40" src="<?php echo e(asset('assets/img/logo.png')); ?>" alt="">
    </a>
    <hr>
</div>
    <div id="app">
                    ...
                    <ul class="navbar-nav mx-auto">
                        ...
                        <?php if(auth()->guard()->guest()): ?>
                            <?php if(Route::has('login')): ?>
                                <li class="nav-item">
                                    <a class="nav-link text-dark" href="<?php echo e(route('login')); ?>"><?php echo e(__('ورود')); ?></a>
                                </li>
                            <?php endif; ?>

                            <?php if(Route::has('register')): ?>
                                <li class="nav-item">
                                    <a class="nav-link text-dark" href="<?php echo e(route('register')); ?>"><?php echo e(__('ثبت نام')); ?></a>
                                </li>
                            <?php endif; ?>
                        <?php else: ?>
