                    ...
                    <div class="row">
                        @for($m=0;$m<4;$m++)
                            <div class=" col-3  contact-miniicon  text-center">
                                <div class="space-5">
                                    <img src="{{asset($mini_icons[$m]['image'])}}" class="minilogo_w">
                                    <b class="title-3 light-black">{{$mini_icons[$m]['title']}}</b>
                                </div>
                            </div>
                        @endfor
                    </div>
                    ...
                    <section id="offercarousel" class="carousel slide carousel-fade card border_all"
                        ...
                        <div class="row m-0">
                            ...
                            <div class="carousel-inner p-0 col-12 col-lg-12">
                                ...
                                @foreach($offer_carousels as $offer_carousel)
                                    <div class="carousel-item @if($loop->first) active @endif">
                                        <div class="row m-0">
                                            <div class="right-col col-5 d-flex imgboxofer">
                                                <a class="w-100 text-center"
                                                   href="{{route('single_product',['slug'=>$offer_carousel['slug']])}}">
                                                    <img src="{{asset($offer_carousel['image'])}}" class="img-fluid"
                                                         alt="">
                                                    <span  class="discount-percent">{{$offer_carousel['discount']}}</span>
                                                </a>
                                            </div>
                                            <div class="left-col col-7">
                                                <h2 class="product-title ">
                                                    <a href="{{route('single_product',['slug'=>$offer_carousel['slug']])}}"> {{$offer_carousel['title']}} </a>
                                                </h2>
                                                <hr class="hr-text" data-content="{{$offer_carousel['hr_tag']}}">
                                                ...
                                                <div class="price space-15">
                                                    <del><span>{{$offer_carousel['old_price']}}<span>تومان</span></span>
                                                    </del>
                                                    <ins><span>{{$offer_carousel['new_price']}}<span>تومان</span></span>
                                                    </ins>
                                                </div>
                ...
                <div class="col-3 hidden-xs hidden-md">
                    <div class="widget-bid-s widget card border_all ">
                        <div id="bid-s" class="owl-carousel owl-theme">
                            @foreach($offer_carousels as $offer_carousel)
                                <div class="item">
                                    <a href="{{route('single_product',['slug'=>$offer_carousel['slug']])}}">
                                        <img src="{{asset($offer_carousel['image'])}}" class="w-100" alt="">
                                    </a>
                                    <h3 class="product-title">
                                        <a href="{{route('single_product',['slug'=>$offer_carousel['slug']])}}"> {{Str::limit($offer_carousel['title'],40)}} </a>
                                    </h3>
                                    <div class="price">
                                        <span class="amount">{{$offer_carousel['new_price']}}<span>تومان</span></span>
                                    </div>
                                </div>
                            @endforeach
                        </div>
                                    ...
                                    <div class="col-6 col-lg-3">
                                        <div class="widget-banner card border_all">
                                            <a href="category-search.html" target="_blank">
                                                <img class="img-fluid" src="{{asset($banner_ads[$j]['image'])}}" alt="">
                                            </a>
                                        </div>
                                    </div>
                                @endfor
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="widget widget-product card border_all bglight pad_time_prod" id="shegeft_1">
                                    ...
                                    @foreach($products as $product)
                                        <div class="item">
                                            ...
                                            <h2 class="product_title">
                                                <a href="{{route('single_product',['slug'=>$product['slug']])}}"> {{Str::limit($product['title'],25)}}</a>
                                            </h2>
                                            <div class="price">
                                                <del><span>{{$product['old_price']}}<span>تومان</span></span></del>
                                ...
                                <a href="{{route('list_category')}}" class="view_more">مشاهده بیشتر</a>
                            ...
                            <div class="row">
                                @for($i=8; $i>=7 ; $i--)
                                    <div class="col-12 col-lg-6">
                                        <div class="widget-banner card border_all">
                                            <a href="category-search.html" target="_blank">
                                                <img class="img-fluid" src="{{asset($banner_ads[$i]['image'])}}" alt="">
                                            </a>
                                        </div>
                                    </div>
                                @endfor
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="widget widget-banner card border_all">
                                <a href="category-search.html" target="_blank">
                                    <img class="img-fluid" src="{{asset($banner_ads[9]['image'])}}" alt="">
                                </a>
                            </div>
                        </div>
                    </div>
                                        ...
                                        <div class="col-6 col-md-2 contact-bigicon">
                                            <a href="#" target="_blank">
                                                <img class="img-responsive imgpad"
                                                     src="{{asset($product_cats[$i]['image'])}}" alt=""/>
                                                <b class="title-3 light-black">{{$product_cats[$i]['name']}}</b>
                                            </a>
                ...
                <div class="col-12">
                    <div class=" widget-blog  border_all ">
                        ...
                        <div class="Blog-carousel owl-carousel owl-theme">
                            @foreach($_magazines as $_magazine)
                                <div class="item">
                                    <a href="{{route('single_blog',['slug'=>$_magazine['slug']])}}">
                                        <img src="{{asset($_magazine["image"])}}" class="img-fluid" alt="">
                                    </a>
                                    <a href="{{route('single_blog',['slug'=>$_magazine['slug']])}}">
                                        <h2 class="Blog_title">
                                            {{Str::limit($_magazine['title'],90)}}
                                        </h2>
                                    </a>
                                    <div class="Blog_list">
                             ...
                             {{$date = Jalalian::forge($_magazine['created_at'])->format(' %d %B %Y')}}
                                          </span>
                                    </div>
                                </div>
                            @endforeach
