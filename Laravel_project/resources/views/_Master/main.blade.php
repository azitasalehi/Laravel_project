@php use App\Models\Sub_Category; @endphp
    <!DOCTYPE html>
<html lang="fa">
<head>
    <meta charset="utf-8"/>
    ...
    <link href="{{asset('assets/fonts/font-awesome/css/fontawesome.min.css')}}" rel="stylesheet"/>
    <link href="{{asset('assets/fonts/font-awesome/css/solid.css')}}" rel="stylesheet"/>
    <link href="{{asset('assets/css/bootstrap.min.css')}}" rel="stylesheet"/>
    <link href="{{asset('assets/css/main_ui.css')}}" rel="stylesheet"/>
    ...
    <link href="{{asset('assets/css/main.css?15')}}" rel="stylesheet"/>
...
<div class="top-section fullscreen-container">
    <img src="{{asset($_setting['banner'])}}" class="h-100">
</div>
<!--start mobile header -->
    ...
    <header class="Masai-header default">
            ...
            <div class="row">
                ...
                <div class="col-lg-8 col-md-5 col-sm-8 col-7">
                    <div class="search-area default">
                        <form method="post" action="{{route('search_product')}}" class="search">
                            @csrf
                            <input name="search" type="text" placeholder="جستجو">
                            <button type="submit"><img src="{{asset('assets/img/search.png')}}" alt="تایید"></button>
                        </form>
                    </div>
                </div>
                <div class="col-md-2 col-sm-12">
                    ...
                    <div class="user_head">
                        <a href="{{route('login')}}" class="iconhead">
                            <i class="{{$_icons['user']}} pl-3" aria-hidden="true"></i>
                        </a>
                    </div>
                    <div class="cart dropdown masai_dropdown">
                        ...
                        <a href="#" class="dropdown-toggle iconhead" data-toggle="dropdown" id="navbar_a">
                            <i class="{{$_icons['cart']}}" aria-hidden="true"></i>
                        </a>
                            ...
                            <div class="dropdown-menu" aria-labelledby="navbar_a">
                                <ul class="m_cart-list">
                                    @foreach($carts as  $cart)
                                        @if($cart['slug']!==null)
                                            <li class="m_cart_li1">
                                                <a href="{{route('delete-cart',['slug'=>$cart['slug']])}}"><i
                                                        class="fa fa-times" aria-hidden="true"></i></a>
                                                <a href="{{route('single_product',['slug'=>$cart['slug']])}}"
                                                   class="m_cart-item">
                                                    <div class="m_cart-item-content">
                                                        <div class="m_cart-item-image">
                                                            <img src="{{asset($cart['mini_image'])}}"/>
                                                        </div>
                                                        <div class="m_cart-item-details">
                                                            <div class="m_cart-item-title">{{$cart['title']}}
                                                            </div>
                                ...
                                <div class="btn_cart">
                                    <form method="get" id="cartForm">
                                        @csrf
                                        <a href="{{route('cart-page')}}" id="cart" class="btn btn_sabad">مشاهده سبد</a>
                                ...
                                @else
                                    <div class="dropdown-menu" aria-labelledby="navbar_a">
                                        <ul class="m_cart-list">
                                            <li class="m_cart_li1">
                                                <a href="{{route('cart-page',['slug'=>'سبد-خرید'])}}"
                                                   class="m_cart-item">
                                                    <div class="m_cart-item-content">
                                                        <div class="m_cart-item-image">
                                                            <img src="{{asset('assets/img/empty-cart.png')}}"/>
                                                        </div>
                                                        <div class="m_cart-item-details">
        ...
        <nav class="nav_header">
            <ul class="nav__ullist">
                            ...
                            @foreach($_categories as $category)
                                @if($category['status']==0)
                                    <li class="child_mno-drobdown">
                                        <a href="#" class="run">{{$category['name']}}</a>
                                        <div class="mega_meno">
                                                    ...
                                                    <ul class="mega_meno--block">
                                                        @foreach($menu_subs as $menu_sub)
                                                            <li class="list_mega border_left">
                                                                <a href="#"
                                                                   class="mega_link--link texr_header">{{$menu_sub['name']}}</a>
                                                            </li>
                                                            ...
                                                            @foreach($subs as $sub)
                                                                <li class="list__mega--itmes">
                                                                    <a href="#"
                                                                       class="list__mega--link">{{$sub['name']}}</a>
                                                                </li>
                                                            @endforeach
                                                        @endforeach
                                                    </ul>
                                            ...
                                            <ul class="ul_list--cecond">
                                                <ul class="mega_meno__cecond">
                                                    ...
                                                    @foreach($menu_subs as $menu_sub)
                                                        <li class="list_mega border_left">
                                                            <a href="#"
                                                               class="mega_link--link texr_header">{{$menu_sub['name']}}
                                                            </a>
                                                        </li>
                ...
                <li class="list_style">
                    <i class="fa fa-search icon-icon" aria-hidden="true"></i><a href="{{route('search_product')}}"
                                                                                class="list__link">صفحه جستجو</a>
                </li>
                <li class="list_style">
                    <i class="fa fa-list-alt icon-icon" aria-hidden="true"></i><a href="{{route('list_category')}}"
                                                                                  class="list__link">
                        دسته بندی محصولات
                    </a>
                </li>
                <li class="list_style">
                    ...
                    <a href="{{route('category_blog')}}" class="list__link">لیست بلاگ</a>
                </li>

                <li class="list_style">
                    <i class="fa fa-phone icon-icon" aria-hidden="true"></i>
                    <a href="{{route('contact-us')}}" class="list__link">تماس با ما</a>
                </li>
    ...
    <footer class="main-footer default">
        ...
        <div class=" servicesbg">
            <div class="footer-services container  space-10">
                <div class="row">
                    @foreach($_footer_services as $_footer_service)
                        <div class="service-item col-2 contact-box text-center">
                            <img src="{{asset($_footer_service['title'])}}" class="width-40"/>
                            <span class="title-1 light-black">{{$_footer_service['description']}}</span>
                        </div>
                    @endforeach
                </div>
        ...
        <div class="container-fluid space-30 bg-map">
            ...
            <div class="footer-widgets container">
                <div class="row">
                    @foreach($_footer_items as $_footer_item)
                        <div class="col-12 col-md-6 col-lg-3">
                            <div class="widget-menu widget card">
                                <div class="card-header">
                                    <h3 class="card-title">{{$_footer_item['title']}}</h3>
                                </div>
                                @php
                                ...
                                <ul class="footer-menu">
                                    @foreach($items as $item)
                                        @if($item==='assets/img/License_1.png')
                                            <a href="#">
